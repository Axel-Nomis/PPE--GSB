DROP DATABASE IF EXISTS db_GSB;

CREATE DATABASE IF NOT EXISTS db_GSB;
...
ALTER TABLE FicheFrais ADD FOREIGN KEY(idEtat) REFERENCES Etat(id);
ALTER TABLE FicheFrais ADD FOREIGN KEY(idVisiteur) REFERENCES Visiteur(id);

ALTER TABLE LigneFraisForfait ADD FOREIGN KEY(idVisiteur, mois) REFERENCES FicheFrais(idVisiteur, mois);
ALTER TABLE LigneFraisForfait ADD FOREIGN KEY(idFraisForfait) REFERENCES FraisForfait(id);

ALTER TABLE LigneFraisHorsForfait ADD FOREIGN KEY(idVisiteur, mois) REFERENCES FicheFrais(idVisiteur, mois);
